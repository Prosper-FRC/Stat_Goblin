...
<body>
  ...
  <div class="container">
    ...
    <div class="card header-card">
      <div class="dropdowns">
        <div>
          <label for="eventDropdown"><strong>Select an Event:</strong></label><br>
        ...
        <div>
          <label for="matchDropdown"><strong>Select a Match:</strong></label><br>
          <select id="matchDropdown" onchange="fetchRobotCards(); if(this.value !== 'all') { fetchPrediction(); }">
    ...
    html += `
          <div class="robot-card" >
            <div class="top-row">
              ...
              <div class="alliance">${robot.alliance}</div>
            </div>
            <!-- View 1: Stat Cards -->
...
function cycleRobotCardViews() {
  ...
  robotCards.forEach(card => {
    ...
    // Event listener: When matchDropdown changes, fetch robot cards.
    document.getElementById('matchDropdown').addEventListener('change', function() {
      ...
      fetchRobotCards();
      // If matchNumber is not "all", automatically fetch prediction (if desired, you could chain this as well).
      if (matchNumber !== "all") {
        fetchPrediction();
      }
    });
